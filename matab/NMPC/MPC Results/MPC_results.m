...
plot([-uo+20 uo-20],[-vo+20 -vo+20],'k--','Linewidth',lwV);
plot([-uo+20 uo-20],[vo-20 vo-20],'k--','Linewidth',lwV);
text(-70,-150,'$\textrm{Features inside the FOV}$','interpreter','latex','fontsize',12);
set(gca,'ticklabelinterpreter','latex',...
    'fontsize',fontsizeTicks)
...
ylim([-vo vo])
set(gca,'Ydir','reverse')
print -dpng System_movement_mpc
print -depsc System_movement_mpc
...
print -dpng error_movement_mpc
print -depsc error_movement_mpc
...
print -dpng control_mpc
print -depsc control_mpc
...
set(gcf, 'PaperPositionMode', 'manual');
box on
plot(t(1:length(t_sample_mpc)),t_sample_mpc(1,:)*0.5,'-','Color',C9,'LineWidth',lw*1.2); hold on
xlim([0 89])
grid minor;
...
set(gca,'ticklabelinterpreter','latex',...
        'fontsize',fontsizeTicks)
%xlabel('$\textrm{Time}[s]$','interpreter','latex','fontsize',fontsizeLabel)
ylabel('$\textrm{Computational Time}[s]$','interpreter','latex','fontsize',fontsizeLabel)
xlabel('$\textrm{Time}[s]$','interpreter','latex','fontsize',fontsizeLabel)
%title({'(a)'},'fontsize',fontsizeTitel,'interpreter','latex')
% set(gca,'Xticklabel',[])
legend({'$C_t$'},'interpreter','latex','fontsize',fontsizeLegend)
print -dpng time_mpc
print -depsc time_mpc
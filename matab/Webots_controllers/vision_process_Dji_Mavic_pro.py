...
class ImageConverter:
    def __init__(self):
        ...
        self.image_sub = rospy.Subscriber("/Mavic_2_PRO/camera_lr/", Image, self.callback)
        ...
        self.pixel_pub = rospy.Publisher("Mavic_2_PRO/Pixels_data", Pixel, queue_size=10)
...
def main(args):
    rospy.init_node('Opencv_process_Mavic_2_PRO', anonymous=False)
    ic = ImageConverter()
    try:
        rospy.spin()
